            ...
            <td class="table-content staff-detail w-100" v-if="isShowDetail">
              <div class="row border-bottom-0">
                ...
                <div class="col-9">
                  <div class="row">
                    <div class="col-lg-6">
                      <p><span class="fw-bold">Họ và tên:</span> {{ staff.name }} </p>
                      <p><span class="fw-bold">Số điện thoại:</span> {{ staff.phone }}</p>
                      <p><span class="fw-bold">Email:</span> {{ staff.email }}</p>
                      <p><span class="fw-bold">Địa chỉ:</span> {{ staff.address }}</p>

                    </div>
                    <div class="col-lg-6">
                      <p><span class="fw-bold">Tuổi:</span> {{ staff.age }}</p>
                      <p><span class="fw-bold">Mã nhân viên:</span> HN{{ staff.id }}</p>
                      <p><span class="fw-bold">Bộ phận:</span> {{ staff.lang }}</p>
                      <p><span class="fw-bold">Thời gian tuyển:</span> {{ staff.time }}</p>
                    </div>
                    <p><span class="fw-bold">Thông tin khác:</span> {{ staff.moreInfo }}</p>
                  </div>
                </div>
              </div>
